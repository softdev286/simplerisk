...
//define('VERSION_NAME', 'complianceforge_scf_extra_version');

global $complianceforge_scf_updates;
$complianceforge_scf_updates = array(
);

/********************************************************
 * FUNCTION: UPGRADE COMPLIANCEFORGE SCF EXTRA DATABASE *
 ********************************************************/
function upgrade_complianceforge_scf_extra_database()
{
    global $complianceforge_scf_updates;

    $version_name = 'complianceforge_scf_extra_version';
    ...
    if (array_key_exists($db_version, $complianceforge_scf_updates))
    {
        // Get the function to upgrade to the next version
        $function = $complianceforge_scf_updates[$db_version];
